...
//------------------------------------------------------------------------------
{
	...
	for ( double t = 0 ; t <= 3.0  ; t+=0.01 )
	{
		...
		// 左2/3
		pers.pen.pset3d( gra, pers, vect3(t, 4+ N1(t,0,2), 0), rgb(1,1,0), 1 );
		pers.pen.pset3d( gra, pers, vect3(t, 4+ f1a(t), 0), rgb(1,0,0), 1 );
		pers.pen.pset3d( gra, pers, vect3(t, 4+ N1(t,0,2)*f1a(t), 0), rgb(1,1,1), 2 );

		// 右2/3
		pers.pen.pset3d( gra, pers, vect3(t, 2+ N1(t,1,3), 0), rgb(1,1,0), 1 );
		pers.pen.pset3d( gra, pers, vect3(t, 2+ f1b(t), 0), rgb(1,0,0), 1 );
		pers.pen.pset3d( gra, pers, vect3(t, 2+ N1(t,1,3)*f1b(t), 0 ), rgb(1,1,1), 2 );
