...
//------------------------------------------------------------------------------
{
	...
	pers.grid.DrawGrid3d( gra, pers, vect3(0,0,0), mat33::mrotx(rad(0)), 26, 26, 1, rgb(0.2,0.2,0.2), false );
	...
	// 描画：箱
	{
		...
		for ( Impl::Box& box : pImpl->tblBox )
		{
			...
			if ( box.bWall == false )
			{
				...
				ss.str("");
				ss << box.vel << "m/s";
				pers.prim.DrawArrow( gra, pers, text_y, v0, v1 ,5	, rgb(1,0,1), ss.str(), false, false,false );
			}
